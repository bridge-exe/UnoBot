Hi there, what a fun project to work on! It was done for a class, and as such, its file layout is in accordance with turn in guidelines.
...
Third, I tested the difficulty of the game, and found that the player won around half the time, which I think to be ideal!

Please have fun. It runs best after having been exported in its entierty to a Notebook.
