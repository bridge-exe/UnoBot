...
Firstly, I recognize that both the begin_turn and computer_turn methods are long, and are pulling a lot of weight. But the reason is that for the game to work, the turns have to alternate, which, in the first draft of the program with separate methods that all checked inputs individually, was a spaghetti-code mess. It was a lot cleaner to use begin_turn as more of a main method. 
